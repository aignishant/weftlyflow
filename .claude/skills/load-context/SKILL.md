---
name: load-context
description: Orient a fresh Claude Code session on Weftlyflow. Manual invocation. Reads the spec, the current memory index, and git state; returns a concise situational summary.
...
1. **Project** — "Weftlyflow, Python workflow automation platform, Phase X."
